...
/// Indicates if the user is on a free trial of a subscription. Specify 1
/// to indicate true and 0 to indicate false (Int).
/// @code
///  let params = [
...
///  ]
/// @endcode
static const char*const kParameterFreeTrial  =
    "free_trial";
...
/// Indicates if an item's price is discounted. Specify 1 to indicate true
/// and 0 to indicate false (Int).
/// @code
///  let params = [
...
///  ]
/// @endcode
static const char*const kParameterPriceIsDiscounted
     = "price_is_discounted";
...
///  ]
/// @endcode
static const char*const kParameterProductID  =
    "product_id";
...
///  ]
/// @endcode
static const char*const kParameterProductName  =
    "product_name";
...
/// Indicates if the purchase is a subscription. Specify 1 to indicate
/// true and 0 to indicate false (Int).
/// @code
///  let params = [
...
///  ]
/// @endcode
static const char*const kParameterSubscription  =
    "subscription";
